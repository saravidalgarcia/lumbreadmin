        ...
        <div class="div-form new-form">
            <section>
                <form name="formUpdateUsuario" onsubmit="updateUsuario(<?= $usuario['id']; ?>); return false">
                    <input id="username" type="text" name="username" placeholder="Nombre de usuario" value="<?= $usuario['username']; ?>" required>
                    <br>
                    <input id="email" type="email" name="email" placeholder="Email" value="<?= $usuario['email']; ?>" required>
                    <br>
